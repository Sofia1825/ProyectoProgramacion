...
def actualizar_estado():
    ...
    # Suma total de vasos hoy si existe el registro
    if pos != -1:
        total = sum(registro_agua[pos]['vasos']) 
    else:
        total = 0
...
def ver_progreso():
    ...
    try:
        ...
        messagebox.showwarning("Error", "Formato de fecha inválido. Usa AAAA-MM-DD.")
        return 
